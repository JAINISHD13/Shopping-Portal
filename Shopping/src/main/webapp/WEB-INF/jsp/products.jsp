					...
					<div class="col-md-3 product-agileinfo-grid">
								...
								<li><input type="checkbox" checked="checked" id="item-0" /><label
									...
									<ul>
										<li><input type="checkbox" id="item-0-0" /><label
											for="item-0-0">Ethnic Wear</label>
											<ul>
								...
								<li><input type="checkbox" id="item-1" checked="checked" /><label
									...
									<ul>
										<li><input type="checkbox" checked="checked"
											id="item-1-0" /><label for="item-1-0">New Arrivals</label>
											<ul>
												<li><a href="products.html">Shirts</a></li>
												<li><a href="products.html">Shoes</a></li>
												<li><a href="products.html">Pants</a></li>
						...
						<div class="cat-img">
							<img class="img-responsive "
								src="<c:url value = "/assets/images/45.jpg"/>" alt="">
						</div>
					</div>
					<div class="col-md-9 product-agileinfon-grid1 w3l">
						<div class="product-agileinfon-top">
							<div class="col-md-6 product-agileinfon-top-left">
								<img class="img-responsive "
									src="<c:url value = "/assets/images/img1.jpg"/>" alt="">
							</div>
							<div class="col-md-6 product-agileinfon-top-left">
								<img class="img-responsive "
									src="<c:url value = "/assets/images/img2.jpg"/>" alt="">
							</div>
							<div class="clearfix"></div>
						</div>
								...
								<ul id="myTab" class="nav nav-tabs left-tab" role="tablist">
									<li role="presentation" class="active"><a href="#home"
										...
										aria-controls="home" aria-expanded="true"><img
											src="<c:url value = "/assets/images/menu1.png"/>"></a></li>
									<li role="presentation"><a href="#profile" role="tab"
										id="profile-tab" data-toggle="tab" aria-controls="profile"><img
											src="<c:url value = "/assets/images/menu.png"/>"></a></li>
								</ul>
													...
													<div class="grid-arrival">
														<figure>
															<a href="#" class="new-gri" data-toggle="modal"
																...
																<div class="grid-img">
																	<img src="<c:url value = "/assets/images/p6.jpg"/>"
													...
													<div class="grid-arrival">
														<figure>
															<a href="#" class="new-gri" data-toggle="modal"
																data-target="#myModal1">
																<div class="grid-img">
																	<img src="<c:url value = "/assets/images/p14.jpg"/>"
																		class="img-responsive" alt="">
																</div>
																<div class="grid-img">
													...
													<div class="grid-arrival">
														<figure>
															<a href="#" class="new-gri" data-toggle="modal"
																data-target="#myModal1">
																<div class="grid-img">
																	<img src="<c:url value = "/assets/images/i2.jpg"/>"
																		class="img-responsive" alt="">
																</div>
																<div class="grid-img">
																	<img src="<c:url value = "/assets/images/i1.jpg"/>"
																		class="img-responsive" alt="">
																</div>
															</a>
														</figure>
													...
													<div class="grid-arrival">
														<figure>
															<a href="#" class="new-gri" data-toggle="modal"
																data-target="#myModal1">
																<div class="grid-img">
																	<img src="<c:url value = "/assets/images/i4.jpg"/>"
																		class="img-responsive" alt="">
																</div>
																<div class="grid-img">
																	<img src="<c:url value = "/assets/images/i3.jpg"/>"
																		class="img-responsive" alt="">
																</div>
															</a>
														</figure>
													...
													<div class="grid-arrival">
														<figure>
															<a href="#" class="new-gri" data-toggle="modal"
																data-target="#myModal1">
																<div class="grid-img">
																	<img src="<c:url value = "/assets/images/i6.jpg"/>"
																		class="img-responsive" alt="">
																</div>
																<div class="grid-img">
																	<img src="<c:url value = "/assets/images/i5.jpg"/>"
																		class="img-responsive" alt="">
																</div>
															</a>
														</figure>
													...
													<div class="grid-arrival">
														<figure>
															<a href="#" class="new-gri" data-toggle="modal"
																data-target="#myModal1">
																<div class="grid-img">
																	<img src="<c:url value = "/assets/images/i8.jpg"/>"
																		class="img-responsive" alt="">
																</div>
																<div class="grid-img">
																	<img src="<c:url value = "/assets/images/i7.jpg"/>"
																		class="img-responsive" alt="">
																</div>
															</a>
														</figure>
													...
													<div class="grid-arrival">
														<figure>
															<a href="#" class="new-gri" data-toggle="modal"
																data-target="#myModal1">
																<div class="grid-img">
																	<img src="<c:url value = "/assets/images/i10.jpg"/>"
																		class="img-responsive" alt="">
																</div>
																<div class="grid-img">
																	<img src="<c:url value = "/assets/images/i9.jpg"/>"
																		class="img-responsive" alt="">
																</div>
															</a>
														</figure>
													...
													<div class="grid-arrival">
														<figure>
															<a href="#" class="new-gri" data-toggle="modal"
																data-target="#myModal1">
																<div class="grid-img">
																	<img src="<c:url value = "/assets/images/i12.jpg"/>"
																		class="img-responsive" alt="">
																</div>
																<div class="grid-img">
																	<img src="<c:url value = "/assets/images/i11.jpg"/>"
																		class="img-responsive" alt="">
																</div>
															</a>
														</figure>
													...
													<div class="grid-arrival">
														<figure>
															<a href="#" class="new-gri" data-toggle="modal"
																data-target="#myModal1">
																<div class="grid-img">
																	<img src="<c:url value = "/assets/images/i14.jpg"/>"
																		class="img-responsive" alt="">
																</div>
																<div class="grid-img">
																	<img src="<c:url value = "/assets/images/i13.jpg"/>"
																		class="img-responsive" alt="">
																</div>
															</a>
														</figure>
											...
											<div class="col-md-8 product-tab1-grid1 simpleCart_shelfItem">
												...
												<div class="women">
													...
													<p>Lorem ipsum dolor sit amet, consectetur adipiscing
														elit. Atqui iste locus est, Piso, tibi etiam atque etiam
														confirmandus, inquam; Refert tamen, quo modo. Quod autem
														meum munus dicis non equidem recuso, sed te adiungo
														socium.</p>
													<p>
														<del>$100.00</del>
														<em class="item_price">$70.00</em>
