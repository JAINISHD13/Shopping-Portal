								...
								<tbody>
									<c:forEach var="product" items="${products}">
										<tr>
											...
											<td><a
												href="${pageContext.request.contextPath}/admin/editProduct.html?id=${product.id}">
													<img
													src="${pageContext.request.contextPath}/admin/bootstrap/img/edit.png"
													style="width: 20px; height: 25px">
											</a></td>
											<td><a
												href="${pageContext.request.contextPath}/admin/deleteProduct.html?id=${product.id}"><img
