	...
	<div class="container">
		<div class="footer-grids">
			<div class="col-md-3 footer-grid">
				<h4>About</h4>
				<p>We are here for making people's life easy and deliver better
					quality products.</p>
			...
			<div class="col-md-3 footer-grid foot">
				...
				<ul>
					<li><i class="glyphicon glyphicon-map-marker"
						aria-hidden="true"></i><a href="#">9th floor - Palace Building
							-Bapunagar,ahmedabad,india</a></li>
					<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i><a
						href="#">+91-7405235315</a></li>
					<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a
						href="mailto:example@mail.com"> jinaldesai@mail.com</a></li>
